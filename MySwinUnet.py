...
class SwinUnet(nn.Module):
    def __init__(self,patch_size=4,in_chans=1,num_classes=2,
        ...
        for i_layer in range(self.num_layers):
            ...
            if i_layer ==0 :
                layer_up = PatchExpand(dim=int(embed_dim * 2 ** (self.num_layers-1-i_layer)), dim_scale=2)
            else:
                layer_up = BasicLayer_up(dim=int(embed_dim * 2 ** (self.num_layers-1-i_layer)),
                                ...
                                mlp_ratio=mlp_ratio,
                                qkv_bias=qkv_bias,
                                drop=drop_rate, attn_drop=attn_drop_rate,# 4-1-1=2  [2,2]       4-1-1+1 = 3 [2,2,2]
        ...
        self.up = FinalPatchExpand(dim_scale=patch_size,dim=embed_dim)
